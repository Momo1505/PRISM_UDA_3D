...
_base_ = [
    ...
    '../_base_/models/unetr.py',
    # GTA->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/NAME_OF_DATASET_FILE.py',
...
#         hr_loss_weight=0.1,num_classes=2),
...
uda = dict(
    ...
    mask_generator=dict(
        type='block', mask_ratio=0.7, mask_block_size=64, _delete_=True),source="I3",noise=2,from_3D=True)
...
exp = 'basic'
name_dataset = 'DATASET_NAME' # adapt the configs below for your use case
name_architecture = 'hrda1-512-0.1_daformer_sepaspp_sl_mitb5' 
name_encoder = 'mitb5'
name_decoder = 'hrda1-512-0.1_daformer_sepaspp_sl'
name_uda = 'dacs_a999_fdthings_rcs0.01-2.0_cpl2_m64-0.7-spta' # you won't need to change this
name_opt = 'adamw_6e-05_pmTrue_poly10warm_1x2_40k' # you won't need to change this
